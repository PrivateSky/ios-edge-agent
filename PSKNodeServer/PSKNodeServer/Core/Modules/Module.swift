...
enum ModuleInitialization<ModuleInputType, ErrorType: Error> {
    typealias ControllerHierarchyInsertion = (UIViewController, _ completion: @escaping VoidBlock) -> Void
...
struct AnyModuleInitializer<ModuleInputType, ErrorType: Error>: ModuleInitializer {
    private let initializeFn: (@escaping (UIViewController, @escaping VoidBlock) -> Void,
    ...
    func initializeModuleWith(controllerInHierarchyInsertion: @escaping (UIViewController, @escaping VoidBlock) -> Void, completion: @escaping ModuleInitialization<ModuleInputType, ErrorType>.Completion) {
